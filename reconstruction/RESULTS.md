...
| Tricky Trials | [R17](../artwork/10-tricky-trials/expanded-clean-scene-2198x1440.png) (2198 x 1440); [R16](../artwork/10-tricky-trials/titled-breeze-variant-2196x1235.png) (2196 x 1235) | Corner masonry is inferred, with approximate fine patterns. P16 lettering and side strips retain lower source detail. The enhanced foreground Breeze contains synthesized detail. |
...
| Trails & Tales | [R21](../artwork/13-trails-tales/titled-alternate-sniffer-2058x1158.png) (2058 x 1158); [R23](../artwork/13-trails-tales/promotional-panorama-seams-repaired-4080x1350.png) (4080 x 1350) | The original title and alternate Sniffer retain P21 source detail. The panorama retains its original softness away from the repaired narrow lines. |
...
| Caves & Cliffs Part II | [R28](../artwork/15-caves-cliffs-part-ii/official-title-composite-2560x1440.png) (2560 x 1440) | Lettering retains P28 source detail. |
| Caves & Cliffs Part I | [R30](../artwork/16-caves-cliffs-part-i/official-title-composite-2560x1440.png) (2560 x 1440) | Lettering retains P30 source detail. |
| Nether Update | [R34](../artwork/17-nether-update/custom-title-placement-2560x1440.png) (2560 x 1440) | Custom title placement is unofficial. The original 388-pixel logo is resampled; no claim of recovered logo detail. |
...
| Combat Update | [R49](../artwork/24-combat-update/combat-enhanced-and-resampled-5120x2880.png) (5120 x 2880) | This is an AI-enhanced and resampled derivative, not native 5K source artwork. AI working resolution is only 1672 x 941; the final 5K dimensions do not demonstrate recovered original detail. Fine edges in buildings and wings are inferred; the original remains available for strict source fidelity. |
