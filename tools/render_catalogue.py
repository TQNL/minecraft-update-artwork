...
'''
    ...
    if reconstruction:readme=readme.replace('## Browse the collection','**[Quality review and methods](reconstruction/quality-review/README.md)**\n\n## Browse the collection')
    ...
    markup='\n'.join(page)
    if reconstruction:markup=markup.replace('</nav>','<a href="'+branch_link+'/reconstruction/quality-review/README.md">Quality review &amp; methods</a></nav>',1)
