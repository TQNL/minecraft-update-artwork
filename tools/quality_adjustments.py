...
Requires numpy, Pillow and OpenCV. Apply to the unprocessed source-composite inputs,
not to already processed outputs. Processing parameters are recorded here; current image hashes live in the review.
"""
import numpy as np
import cv2
